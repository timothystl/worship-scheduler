...
- [ ] **G13** — Ghost fund 1771128: Two contributions reference a deleted/retired Breeze fund that no longer appears in Breeze's fund list. (1) Sue Koch: Apr 27 2025, breeze_id=495182958, $40.00. (2) Thanh Nguyen: Feb 22 2026, breeze_id=512469513, $25.00. Options: (a) user fixes contributions in Breeze to use a valid fund and re-syncs, or (b) add hardcoded mapping `'1771128' → <correct_fund_id>` in the sync code. Ask user what fund these should be assigned to. (noted 2026-04-19)
